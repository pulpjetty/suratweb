...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            @endif
            <div class="card">
                <h5 class="card-header bg-primary text-white">Edit Arsip Surat</h5>
                <div class="card-body">
                    <form action="{{url('/arsip'.'/'.$arsip->id)}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                ...
                                value="{{$arsip->tgl_surat}}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="nomor_surat" class="form-control"
                                    value="{{$arsip->nomor_surat}}" id="nomor_surat">
                            </div>
                        </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="jenis_surat" id="jenis"
                                            value="Masuk" {{($arsip->jenis_surat=='Masuk') ? 'checked': ''}} required>
                        <label class="form-check-label" for="jenis">
                            Surat Masuk
                        </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="jenis_surat" id="jenis" value="Keluar"
                        {{($arsip->jenis_surat=='Keluar') ? 'checked': ''}} required>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                @if (Auth::user()->level=='TU')
                    @if ($arsip->pengirim->level=='TU')
                        <input type="file" name="file" class="form-control-file" id="file" accept="application/pdf">
                    @else
                        <input type="file" name="file" class="form-control-file" id="file" accept="application/pdf" disabled>
                    @endif
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-4">
                    <select name="category_id" class="form-control">
                            ...
                            <option value="{{$category->id}}" {{($category->id==$arsip->category_id) ? 'selected': ''}}>{{$category->name}}</option>
                            @endforeach
                        </select>
            </div>
        </div>
